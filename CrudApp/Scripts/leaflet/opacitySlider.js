...
console.log("opacitySlider.js attached.")
...
function onClickHigherOpacity() {
    ...
    console.log("layer options: ", opacity_layer.options)
    opacity_layer.options.rotate = opacity_layer.options.rotate || 0;
    var rotationValue = opacity_layer.options.rotate;

    rotationValue = rotationValue != 0 || rotationValue != null ? 0 : 90;
